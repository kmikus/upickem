...
--
-- Host: localhost    Database: upickem_test
-- ------------------------------------------------------
...
CREATE TABLE `game` (
  ...
  `awayscore` int(3) NOT NULL,
  `gamedate` date NOT NULL,
  `modts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`gameid`)
...
-- Dump completed on 2017-10-07 22:42:03
